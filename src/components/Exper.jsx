...
const Exper = () => {
  return (
    <>
      ...
      <section className="  py-16 px-6 md:px-20" id="experience">
        <Container>
        ...
        <div className="grid md:grid-cols-2  gap-10">
          ...
          <div>
            ...
            <div className="space-y-6 mt-10 ">
             <div className=" border-2 border-[#3BB9FF] shadow-[#3BB9FF]/50 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
               <div className=' flex items-start gap-4 '>
                <div className="p-3 bg-[#3BB9FF] text-[24px] rounded-full ">

                <ImBriefcase   />
                </div>
               <div className="">
                 <h4 className="text-2xl font-bold font-main ">Frontend Developer – Softvance</h4>
             ...
             <div className=" border-2 border-[#3BB9FF] shadow-[#3BB9FF]/50 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
               ...
               <div className="">
                 <h4 className="text-2xl font-bold font-main ">Freelance Web Developer</h4>
             ...
             <div className=" border-2 border-[#3BB9FF] shadow-[#3BB9FF]/50 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
               ...
               <div className="">
                 <h4 className="text-2xl font-bold font-main ">Front-End DEVELOPER - Fiverr</h4>
          ...
          <div>
            ...
            <div className="space-y-6 mt-10">
              <div className=" border-2 border-[#3BB9FF] shadow-[#3BB9FF]/50 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
               ...
               <div className="">
                 <h4 className="text-2xl font-bold font-main ">Higher Secondary Certificate (HSC)</h4>
    ...
    - Focused on Civics, History, and Bengali Literature.
              ...
              <div className=" border-2 border-[#3BB9FF] shadow-[#3BB9FF]/50 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
               ...
               <div className="">
                 <h4 className="text-2xl font-bold font-main ">Frontend Development Course</h4>
              ...
              <div className=" border-2 border-[#3BB9FF] shadow-[#3BB9FF]/50 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
               ...
               <div className="">
                 <h4 className="text-2xl font-bold font-main ">Diploma DEGREE - creative it</h4>
